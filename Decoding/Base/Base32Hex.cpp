...
BYTE Base32HexDecoding::InverseBase32HexTable[256] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
                                                      0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
                                                      0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
                                                      0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0xFF, 0xFF, 0xFF, 0xFE, 0xFF, 0xFF,
...
DecodedBytes Base32HexDecoding::GetDecodedBytes(const char* srcBase32String, UINT64 srcStringLength) {
    ...
    if (srcStringLength > 8) {
        srcStringLength -= 8;
        for(UINT64 i = 0; i < srcStringLength; i++) if(InverseBase32HexTable[srcBase32String[i]] >= 0xFE) return Ret;
        srcStringLength += 8;
    }
    ...
    for(UINT64 i = srcStringLength - 8; i < srcStringLength; i++) {
        if(InverseBase32HexTable[srcBase32String[i]] == 0xFF) return Ret;
    ...
    //PaddingCount could only be 0, 1, 3, 4 or 6. Otherwise the input is illegal.
    switch(PaddingCount) {
        case 0:
