...
void Encryption::AES::AES192::Cipher(BYTE srcBytes[16], UINT32 srcExpandedKey[52]) {
...
void Encryption::AES::AES192::KeyExpansion(BYTE srcKey[24], UINT32 dstExpandedKey[52]) {
