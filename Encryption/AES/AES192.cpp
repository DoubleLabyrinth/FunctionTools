...
BYTE AES192Encryption::SBox[256] = {0x63, 0x7C, 0x77, 0x7B, 0xF2, 0x6B, 0x6F, 0xC5, 0x30, 0x01, 0x67, 0x2B, 0xFE, 0xD7, 0xAB, 0x76,
...
UINT32 AES192Encryption::Rcon[11] = {0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1B, 0x36};

BYTE AES192Encryption::Multiply0x02[256] = {0x00, 0x02, 0x04, 0x06, 0x08, 0x0A, 0x0C, 0x0E, 0x10, 0x12, 0x14, 0x16, 0x18, 0x1A, 0x1C, 0x1E,
...
BYTE AES192Encryption::Multiply0x03[256] = {0x00, 0x03, 0x06, 0x05, 0x0C, 0x0F, 0x0A, 0x09, 0x18, 0x1B, 0x1E, 0x1D, 0x14, 0x17, 0x12, 0x11,
...
void AES192Encryption::Cipher(BYTE srcBytes[16], UINT32 srcExpandedKey[52]) {
...
void AES192Encryption::KeyExpansion(BYTE srcKey[24], UINT32 dstExpandedKey[52]) {
