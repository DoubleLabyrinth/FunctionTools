...
namespace Hash {
    namespace SHA {
        namespace SHA384 {
            ...
            const UINT64 K[80] = {0x428A2F98D728AE22, 0x7137449123EF65CD, 0xB5C0FBCFEC4D3B2F, 0xE9B5DBA58189DBBC, 0x3956C25BF348B538, 0x59F111F1B605D019, 0x923F82A4AF194F9B, 0xAB1C5ED5DA6D8118,
            ...
            SHA384HashResult GetChecksum(const BYTE* srcBytes, UINT64 srcBytesLength);
        }
    }
}
